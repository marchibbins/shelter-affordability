    ...
    render () {
        return (
            <article className="slide">
                ...
                in {this.props.location} have risen {this.props.locationFold} fold.
                    It's getting harder and harder to rent or buy.</h3>
...
const stateToProps = state => pick(state, ['location', 'locationFold']);
